...
# This needs most certainly more work.

def petit_table(columns, filename, figures, row_names=None, column_names=None, dont_align=False):
    write_table(columns, "../tables/" + filename + ".tex", figures=figures, row_names=row_names, column_names=column_names, dont_align=dont_align)
